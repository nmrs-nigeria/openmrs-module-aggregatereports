...
import org.openmrs.module.dataquality.api.impl.DataqualityServiceImpl;
import static org.mockito.Mockito.*;
import static org.hamcrest.Matchers.*;
import static org.junit.Assert.*;

/**
 * This is a unit test, which verifies logic in DataqualityService. It doesn't extend
 * BaseModuleContextSensitiveTest, thus it is run without the in-memory DB and Spring context.
 */
public class DataqualityServiceTest {
	
	@InjectMocks
	DataqualityServiceImpl basicModuleService;
