    ...
    myAjax({startDate:startDate, endDate:endDate}, "otz/getPatientsVLAccess.action").then(function(response){
        ...
        console.log(completed7Modules);
         ...
         for(var i=0; i<monthDifference; i += 6){
            ...
            console.log("patelllllllllllllllllllllllllllllllllllllllllllllllll");
            ...
            patientsWithRepeatVl12MonthsObj[title] = patientsWithRepeatVl12Months;
          ...
          dataQuality_buildBarCharts("Total Patients", vlAccessData, graphArray, "title", "chartVLAccess", "", "none", legendData, true, false, vlAccessMin, vlAccessMax);
             ...
             var legendData = [{color:"#589BD4", title:"# of AYPLHIV enrolled in OTZ who were eligible for 6 monthly VL test"},
                    {color:"#A1a1a1", title:"# of AYPLHIV enrolled in OTZ with VL result for samples taken for 6-monthly vl test"},     
            ...
            var graphArray2 = [
               ...
               {field: "noWithResult", type:"column",  color:"#A1a1a1", valueAxis:1, description:"title", title:"# of AYPLHIV enrolled in OTZ with VL result for samples taken for 6-monthly vl test", isOptimum:"withResult", chartType:"vlotz"},
          ...
          dataQuality_buildBarCharts("Total Patients", vlCoverageData, graphArray2, "title", "chartVlCoverage", "", "none", legendData, true, false, vlCoverageMin, vlCoverageMax);
            ...
            legendData = [{color:"#589BD4", title:"# of AYPLHIV enrolled in OTZ with result in the past 6m"},
                    {color:"#148240", title:"# of AYPLHIV enrolled in OTZ with Undetectable VL in the past 6 months"},
                    {color:"#08A58E", title:"# of AYPLHIV enrolled in OTZ with LLV in the past 6 m"},
                    {color:"#bf6c19", title:"% virally suppressed(6 month VL)"}     
             ]
            graphArray2 = [
               {field: "noEligible", type:"column", valueAxis:1, color:"#589BD4", description:"title", title:"# of AYPLHIV enrolled in OTZ with result in the past 6 months", isOptimum:"withResultPast6Months", chartType:"vlotz"},
               {field: "noWithResult", type:"column", valueAxis:1, newStack:true,  color:"#148240", description:"title", title:"# of AYPLHIV enrolled in OTZ with VL suppressed VL in the past 6 months", isOptimum:"undetectable6Months", chartType:"vlotz"},
               {field: "noLLV", type:"column", valueAxis:1,  color:"#08A58E", description:"title", title:"# of AYPLHIV enrolled in OTZ with low level viraemia in the past 6 months", isOptimum:"llv6Months", chartType:"vlotz"},
          ...
          legendData = [{color:"#589BD4", title:"# of AYPLHIV enrolled in OTZ with result in the past 12 months"},
                    {color:"#148240", title:"# of AYPLHIV enrolled in OTZ with Undetectable VL  in the past 12 months"}, 
                     {color:"#08A58E", title:"# of AYPLHIV enrolled in OTZ with LLV in the past 12 m"},
            ...
            graphArray2 = [
               ...
               {field: "noWithResult", type:"column", valueAxis:1, color:"#148240", newStack:true, description:"title", title:"# of AYPLHIV enrolled in OTZ with Undetectable VL in the past 6 months", isOptimum:"undetectable12Months", chartType:"vlotz"},
               {field: "noLLV", type:"column", valueAxis:1,  color:"#08A58E", description:"title", title:"# of AYPLHIV enrolled in OTZ with low level viraemia in the past 12 months", isOptimum:"llv12Months", chartType:"vlotz"},
          ...
          dataQuality_buildBarCharts("Total Patients", vlSuppressionData12Months, graphArray2, "title", "chartVLSuppressionLast12Months", "", "regular", legendData, true, false);
            ...
            legendData = [{color:"#589BD4", title:"# of AYPLHIV in OTZ with VL within the last 12 months result greater than or equal to 1000 c/m"},
             ...
             graphArray2 = [
               {field: "noWithResultAbove1000", color:"#589BD4", description:"title", title:"# of AYPLHIV in OTZ with VL within the last 12 months result greater than or equal to 1000 c/m", isOptimum:"noWithResultAbove1000", chartType:"vlotz"},
         ...
         var legendData = [{color:"#589BD4", title:"# of AYPLHIV with VL result in the last 12 months >= 1000 c/m who have post EAC VL result"},
            ...
            var graphArray3 = [
               {field: "noRepeat", color:"#589BD4", description:"title", title:"# of AYPLHIV with repeat VL  in the last 12 months", isOptimum:"withRepeatVl", chartType:"vlotz"},
