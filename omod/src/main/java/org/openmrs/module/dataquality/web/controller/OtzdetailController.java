 ...
 */
@Controller("${rootrootArtifactId}.OtzDetailController")
@RequestMapping(value = "module/dataquality/otzdetail.form")
public class OtzdetailController {
	...
	private final String VIEW = "/module/dataquality/otzdetail";
	...
	@RequestMapping(value = { "/module/dataquality/otzdetail" }, method = RequestMethod.GET)
