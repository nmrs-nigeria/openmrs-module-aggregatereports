...
<strong>Note that the age is as at ART start date</strong>
<fieldset>
...
<div class="table-responsive">
        <table class="table-bordered dataTable" width="100%">
            <thead>
                ...
                <th>First Sample Collection Date</th>
                <th>First VL</th>
                <th>Age</th>
                <th>Age Range</th>
            ...
            <tbody>
                ...
                { %>
                    <tr>
                        ...
                        <td><%= patients.get(i).get("firstVLDate")%></td>
                        <td><%= patients.get(i).get("vlResult")%></td>
