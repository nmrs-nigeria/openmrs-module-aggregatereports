...
<div class="container">
    ...
    <table class="table dataTable">
        ...
        <tbody>
            ...
            <tr>
                <td><%= i++ %></td>
                <td># of AYPLHIV in OTZ with baseline VL results (VL within the last 12 months) at enrollment into OTZ and VL result less than 200 c/ml <a href="javascript:void(0);" class="otzInfo" data-key="total_baseline_vl_200"  data-toggle="modal"  data-target="#descriptionModal"><i class=" fa-2x icon-question-sign"></i></a></td>
            ...
            <tr>
                <td><%= i++ %></td>
                <td> # of AYPLHIV in OTZ with baseline VL results (VL within the last 12 months) at enrollment into OTZ and VL result between 200 to less than 1000 c/ml <a href="javascript:void(0);" class="otzInfo" data-key="total_baseline_vl_200_1000"  data-toggle="modal"  data-target="#descriptionModal"><i class=" fa-2x icon-question-sign"></i></a> </td>
                ...
                <td><%= i++ %></td>
                <td># of AYPLHIV in OTZ with baseline VL results (VL within the last 12 months) at enrollment into OTZ and VL result greater than or equal to 1000 c/ml <a href="javascript:void(0);" class="otzInfo" data-key="total_baseline_vl_1000"  data-toggle="modal"  data-target="#descriptionModal"><i class=" fa-2x icon-question-sign"></i></a></td>
            ...
            <tr>
                <td><%= i++ %></td>
                <td># of AYPLHIV in OTZ with VL result at baseline within the last 6 months at enrollment into OTZ and VL less than 200 c/ml <a href="javascript:void(0);" class="otzInfo" data-key="total_vl_result_200"  data-toggle="modal"  data-target="#descriptionModal"><i class=" fa-2x icon-question-sign"></i></a></td>
            ...
            <tr>
                <td><%= i++ %></td>
                <td># of AYPLHIV in OTZ with VL result at baseline within the last 6 months at enrolment into OTZ and VL result is between 200 to less than 1000 c/ml 
            ...
            <tr>
                <td><%= i++ %></td>
                <td># of AYPLHIV in OTZ with VL result at baseline within the last 6 months at enrollment into OTZ and VL greater than or equal to 1000 c/ml <a href="javascript:void(0);" class="otzInfo" data-key="total_vl_result_1000"  data-toggle="modal"  data-target="#descriptionModal"><i class=" fa-2x icon-question-sign"></i></a></td>
            ...
            <tr>
                <td><%= i++ %></td>
                <td># of AYPLHIV in OTZ with baseline VL results <1000 c/ml whose VL result for sample collected at month zero is less than 200 c/ml 
            ...
            <tr>
                <td><%= i++ %></td>
                <td># of AYPLHIV in OTZ with baseline VL results <1000 c/ml whose VL result for sample collected at month zero is between 200 to less than 1000 c/ml
            ...
            <tr>
                <td><%= i++ %></td>
                <td># of AYPLHIV in OTZ with baseline VL results <1000 c/ml  whose VL result for sample collected at month zero is greater than or equal to 1000 c/ml
            ...
            <tr>
                <td><%= i++ %></td>
                <td># of AYPLHIV in OTZ with result for sample taken for routine VL test during the follow up period less than 200 copies/ml
            ...
            <tr>
                <td><%= i++ %></td>
                <td># of AYPLHIV in OTZ with result for sample taken for routine VL test during the follow up period between 200 to less than 1000 copies/ml
            ...
            <tr>
                <td><%= i++ %></td>
                <td># of AYPLHIV enrolled in OTZ  in the cohort month with VL result within the last 12 months less than 200 copies/ml
            ...
            <tr>
                <td><%= i++ %></td>
                <td># of AYPLHIV enrolled in OTZ in the cohort month with VL result within the last 12 months is between 200 to less than 1000 copies/ml
            ...
            <tr>
                <td><%= i++ %></td>
                <td># of AYPLHIV enrolled in OTZ  in the cohort month with VL result within the last 12 months greater than or equal to 1000 copies/ml
            ...
            <tr>
                <td><%= i++ %></td>
                <td># of AYPLHIV enrolled in OTZ in the cohort month with VL result within the last 12 months greater than or equal to 1000 copies/ml and completed EAC
            ...
            <tr>
                <td><%= i++ %></td>
                <td># of AYPLHIV enrolled in OTZ in the cohort month with VL result within the last 12 months greater than or equal to 1000 copies/ml who have repeat VL result
            ...
            <tr>
                <td><%= i++ %></td>
                <td># of AYPLHIV enrolled in OTZ in the cohort month with VL result within the last 12 months greater than or equal to 1000 copies/ml whose repeat VL result is less than 200 copies/ml
            ...
            <tr>
                <td><%= i++ %></td>
                <td># of AYPLHIV enrolled in OTZ in the cohort month with VL result within the last 12 months greater than or equal to 1000 copies/ml whose repeat VL result is between 200 to less than 1000 copies/ml
            ...
            <tr>
                <td><%= i++ %></td>
                <td># of AYPLHIV enrolled in OTZ in the cohort month with VL result within the last 12 months greater than or equal to 1000 copies/ml whose repeat VL result is greater than or equal to 1000 copies/ml
